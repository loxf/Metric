...
public class TargetNoticeUserDaoImpl extends MongoDaoBase<TargetNoticeUser> implements TargetNoticeUserDao {
    private final String collectionName = "target_notice_user";

    @Override
    public void insert(TargetNoticeUser object) {
        super.insert(object, collectionName);
    }

    @Override
    public TargetNoticeUser findOne(Map<String, Object> params) {
        return super.findOne(params, collectionName);
    }

    @Override
    public List<TargetNoticeUser> findAll(Map<String, Object> params) {
        return super.findAll(params, collectionName);
    }

    @Override
    public List<TargetNoticeUser> findByPager(Map<String, Object> params, int start, int end) {
