...
public class QuotaManager {
     ...
     * @return
     */
    public String  insert(QuotaDto quotaDto){
    ...
    public void updateQuotaByCode(String quotaCode,Map<String, Object> setParams){
        Map<String, Object> qryParams=new HashedMap();
        qryParams.put("quotaCode",quotaCode);
        setParams.put("updatedAt",new Date());
        quotaDao.update(qryParams, setParams);
    }
    public QuotaDto getQuotaDtoByParams(Map<String, Object> params){
        QuotaDto quotaDto=new QuotaDto();
        Quota quota = getQuotaByParams(params);
        BeanUtils.copyProperties(quota, quotaDto);
        return quotaDto;
    }

    public Quota getQuotaByParams(Map<String, Object> params){
        return quotaDao.findOne(params);
    }
...
//        return result;
    ...
    public void delQuotaByCode(String quotaCode) {
        Map<String, Object> qryParams=new HashedMap();
        qryParams.put("quotaCode",quotaCode);
        quotaDao.remove(qryParams);
    }
